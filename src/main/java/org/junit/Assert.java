...
public class Assert {
    ...
    public static void assertGreaterThan(float o1, float o2, java.util.Comparator c) {
        assertTrue(c.compare(o1,o2)>0);
    }
    public static void assertGreaterThan(double o1, double o2, java.util.Comparator c) {
        assertTrue(c.compare(o1,o2)>0);
    }
    public static void assertGreaterThan(char o1, char o2, java.util.Comparator c) {
        assertTrue(c.compare(o1,o2)>0);
    }
